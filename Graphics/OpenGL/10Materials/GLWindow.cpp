...
void GLWindow::Render()
{
	...
	m_cLightingShaderProgram->SetUniform("material.ambient", 1.0f, 0.5f, 0.31f);
	m_cLightingShaderProgram->SetUniform("material.diffuse", 1.0f, 0.5f, 0.31f);
	m_cLightingShaderProgram->SetUniform("material.specular", 0.5f, 0.5f, 0.5f);
	m_cLightingShaderProgram->SetUniform("material.shininess", 32.0f);
	m_cLightingShaderProgram->SetUniform("light.position", 10.0f, 0.0f, 0.0f);
	m_cLightingShaderProgram->SetUniform("light.ambient", 0.2f, 0.2f, 0.2f);
	m_cLightingShaderProgram->SetUniform("light.diffuse", 0.5f, 0.5f, 0.5f);
	m_cLightingShaderProgram->SetUniform("light.specular", 1.0f, 1.0f, 1.0f);
