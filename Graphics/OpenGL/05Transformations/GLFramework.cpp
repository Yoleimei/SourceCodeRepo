...
void GLFramework::Render()
{
	...
	glm::mat4 trans;
	trans = glm::rotate(trans, glm::radians((GLfloat)glfwGetTime() * 90.0f), glm::vec3(0.0f, 0.0f, 1.0f));
	trans = glm::translate(trans, glm::vec3(0.5f, -0.5f, 0.0f));
	trans = glm::scale(trans, glm::vec3(0.8, 0.8, 0.8));
	GLuint transformLoc = glGetUniformLocation(m_cShaderProgram->GetProgram(), "unifTransform");
